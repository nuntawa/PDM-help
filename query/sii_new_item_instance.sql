WITH UP
                    ...
                    WHERE  I.COMPANY_ID = '01'
                           AND P.PMA_ID BETWEEN '1001' AND NVL('1001', '1009')
                           AND I.EFFECTIVE_START_DATE BETWEEN DATE '2020-01-01' AND DATE '9999-12-31'
                           AND ( :status = 'ALL' OR ( :status = 'A' AND IS2.STATUS = 'A' ) OR ( :status = 'S' AND IS2.STATUS = 'S' ) )
                           AND ( :siiFlag = 'ALL' OR ( :siiFlag = 'SII' AND I.SII_FLAG = 'Y' ) )
                           AND ( :inventoryCheckFlag = 'ALL' OR ( :inventoryCheckFlag = 'Y' AND I.INVENTORY_CHECK_FLAG = 'Y' ) OR ( :inventoryCheckFlag = 'N' AND I.INVENTORY_CHECK_FLAG = 'N' ) )  

                           ORDER BY I.ITEM_ID ASC, P.PMA_ID ASC, PC.PMA_CATEGORY_ID ASC, PSC.PMA_SUB_CATEGORY_ID ASC, I.EFFECTIVE_START_DATE ASC 